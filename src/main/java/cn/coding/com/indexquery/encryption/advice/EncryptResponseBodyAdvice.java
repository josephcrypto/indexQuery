...
import cn.coding.com.indexquery.encryption.annotation.encrypt.*;
import cn.coding.com.indexquery.encryption.bean.EncryptAnnotationInfoBean;
...
import cn.coding.com.indexquery.encryption.exception.EncryptBodyFailException;
import cn.coding.com.indexquery.encryption.exception.EncryptMethodNotFoundException;
import cn.coding.com.indexquery.encryption.util.*;
...
public class EncryptResponseBodyAdvice implements ResponseBodyAdvice {
    ...
    private String switchEncrypt(String formatStringBody,EncryptAnnotationInfoBean infoBean){
        ...
        if(method == EncryptBodyMethod.AES){
            ...
            return AESEncryptUtil.encrypt(formatStringBody,key, ivKey);
        }
        throw new EncryptBodyFailException();
    }
