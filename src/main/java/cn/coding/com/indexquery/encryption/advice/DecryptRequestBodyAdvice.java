package cn.coding.com.indexquery.encryption.advice;


import cn.coding.com.indexquery.encryption.annotation.decrypt.AESDecryptBody;
import cn.coding.com.indexquery.encryption.annotation.decrypt.DESDecryptBody;
import cn.coding.com.indexquery.encryption.annotation.decrypt.DecryptBody;
import cn.coding.com.indexquery.encryption.annotation.decrypt.RSADecryptBody;
import cn.coding.com.indexquery.encryption.bean.DecryptAnnotationInfoBean;
import cn.coding.com.indexquery.encryption.bean.DecryptHttpInputMessage;
import cn.coding.com.indexquery.encryption.config.EncryptBodyConfig;
import cn.coding.com.indexquery.encryption.enums.DecryptBodyMethod;
import cn.coding.com.indexquery.encryption.exception.DecryptBodyFailException;
import cn.coding.com.indexquery.encryption.exception.DecryptMethodNotFoundException;
import cn.coding.com.indexquery.encryption.util.AESEncryptUtil;
import cn.coding.com.indexquery.encryption.util.CheckUtils;
import cn.coding.com.indexquery.encryption.util.DESEncryptUtil;
import cn.coding.com.indexquery.encryption.util.StringUtils;
...
public class DecryptRequestBodyAdvice implements RequestBodyAdvice {
    ...
    private String switchDecrypt(String formatStringBody,DecryptAnnotationInfoBean infoBean){
        ...
        if(method == DecryptBodyMethod.AES){
            ...
            return AESEncryptUtil.decrypt(formatStringBody,key, ivKey);
        }
